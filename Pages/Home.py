...
class Home:
    ...
    def app(self):
        ...
        # Load assets
        lottie_coding = self.load_lottieurl("https://lottie.host/66535123-7d5b-47d2-bd29-f35b831bccfd/nKC3J3nDm4.json")
        ...
        with st.container():
            ...
            st.write(
                "Cole Jermaine Palmer is an English professional footballer who plays for Chelsea and the England national team."
            )
